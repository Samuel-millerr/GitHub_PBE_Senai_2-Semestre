...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('api', '0003_livro_qtdpaginas_alter_livro_disponivel'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('autor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.author')),
            ],
        ),
        migrations.CreateModel(
            name='Publisher',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nome', models.CharField(max_length=100)),
                ('cpnj', models.CharField(blank=True, max_length=18, null=True, unique=True)),
